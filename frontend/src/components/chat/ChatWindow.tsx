      ...
      >
        {messages.length === 0 ? (
          <div className="text-center py-4 sm:py-8">
            <div className="mx-auto w-8 h-8 rounded-full flex items-center justify-center mb-1 sm:mb-2" style={{ backgroundColor: theme.colors.accent, color: theme.colors.onAccent }}>
